...
class Content(models.Model):
    ...
    image_2 = models.ImageField(
        upload_to='images', verbose_name='Surat 2', blank=True, null=True)
    image_3 = models.ImageField(
        upload_to='images', verbose_name='Surat 3', blank=True, null=True)
    body = models.TextField(verbose_name='Teksti')
    link = models.URLField(verbose_name='Link')
    category = models.CharField(
        max_length=50, choices=CATEGORY_CHOICES, verbose_name='Kategoriýa')
...
class Favorites_Content(models.Model):
    user = models.ForeignKey(
        "users.User", on_delete=models.CASCADE, related_name='favorite_contents')
