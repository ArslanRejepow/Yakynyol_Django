...
from .views import add_to_favourites, home, add_product, profile, update_product_view, update_product, delete_product
...
urlpatterns = [
    ...
    path("add_to_favourites_product", add_to_favourites, name='add_to_favourites_product')
]